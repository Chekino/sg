      ...
      <div className="container">
          ...
          <Card.Body>
            ...
            <div className="row">
              <div className="col-12">
                <h3 style={{ fontWeight: "bold" }}> 870 000,00€</h3>
              </div>
              <div>**** 8856</div>
        ...
        >
          <Modal.Header closeButton>
            ...
            >
              BONJOUR SABRINE FOURNIER
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <p>VOTRE COMPTE EST BLOQUE. FRAIS DE DEBLOCAGE: 68.000€</p>
          </Modal.Body>
          <Modal.Footer>
        ...
        <div color="danger">
          <marquee behavior="" direction="right" className="mt-3">
            STATUT DU COMPTE: COMPTE BLOQUE / FRAIS DE DEBLOCAGE: 68.000€
          </marquee>
        </div>
      </div>
